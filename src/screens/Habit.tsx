...
export function Habit() {
    ...
    // Fazer a barra de progresso responsiva ao se marcar ou desmarcar os hábitos
    ...
    // Função para marcar ou desmarcar os hábitos
    async function handleToggleHabits(habitId: string) {
        ...
        try {
            ...
            console.log(error)
            Alert.alert("Opa", "Não foi possível atualizar o status do hábito.");
        }
    }
